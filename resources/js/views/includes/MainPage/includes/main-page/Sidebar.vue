    ...
    <nav class="sidenav">
        ...
        <div class="sidenav-nav">
            <div class="sidenav-navigation">
                ...
                <a target="_blank" class="sidenav-navigation-item" href="https://nagytommy76.github.io/Wargaming/">World of Tanks</a>
                <a target="_blank" class="sidenav-navigation-item" href="https://recipe-finder-app-c0b4e.firebaseapp.com/">Recept kereső</a>
                <a target="_blank" class="sidenav-navigation-item" href="https://pcboltmvc.000webhostapp.com/">Computer Store</a>
                ...
                <div class="sidenav-contact">
                    ...
                    <Tooltip :text="'GitHub'">
                        <a target="_blank" href="https://github.com/nagytommy76" class="sidenav-contact-item"><font-awesome class="svg-icon" :icon="['fab', 'github']" size="2x"/></a>
                    </Tooltip>
                    <Tooltip :text="'Facebook'">
                        <a target="_blank" href="https://www.facebook.com/tamas.nagy.1029" class="sidenav-contact-item"><font-awesome class="svg-icon" :icon="['fab', 'facebook-square']" size="2x"/></a>
                    </Tooltip>
